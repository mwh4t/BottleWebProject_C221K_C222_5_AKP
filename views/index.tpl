    ...
    <div class="main-content">
        ...
        <div class="theory-content">
            ...
            <div class="theory-text">
                ...
                <p>Учебное веб-приложение на Python с использованием фреймворка Bottle для визуализации и анализа
                    графов.
        ...
        <div class="theory-content">
            <div class="theory-text">
                ...
                <p>Подробнее изучить теорию или произвести расчёт можно на странице поиска Эйлерова цикла.</p>
                <div class="buttons">
        ...
        <div class="theory-content">
            <div class="theory-text">
                ...
                <p>Подробнее изучить теорию или произвести расчёт можно на странице поиска Гамильтонов цикла.</p>
                <div class="buttons">
                    <button type="button" onclick="location.href='/theory#hamilton-theory'">Перейти</button>
                </div>
            </div>
        </div>
        ...
        <div class="theory-content">
            <div class="theory-text">
                ...
                <p>Подробнее изучить теорию или произвести расчёт можно на странице поиска расчёта метрик.</p>
                <div class="buttons">
        ...
        <div class="theory-content">
            ...
            <div class="theory-text">
                ...
                <p>2. Введите данные графа (матрицу смежности или список ребер),
                    предварительно изучив теорию (по желанию).</p>
